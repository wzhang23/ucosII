...
#define VID_BASE				(0x77100000)
#define VIDCON0_REG			__REG(VID_BASE+0x0)
#define VIDCON1_REG			__REG(VID_BASE+0x4)
#define VIDTCON0_REG		__REG(VID_BASE+0x10)
#define VIDTCON1_REG		__REG(VID_BASE+0x14)
#define VIDTCON2_REG		__REG(VID_BASE+0x18)
#define WINCON0_REG			__REG(VID_BASE+0x20)
#define VID0SD0A_REG		__REG(VID_BASE+0x40)
#define VID0SD0B_REG		__REG(VID_BASE+0x44)
#define VID0SD0C_REG		__REG(VID_BASE+0x48)
#define VIDW00ADD0B0_REG	__REG(VID_BASE+0xa0)
#define VIDW00ADD1B0_REG	__REG(VID_BASE+0xd0)
#define VIDW00ADD2_REG		__REG(VID_BASE+0x100)
